...
-- main winbar color
hl('WinBar', colors['background'], colors['gray'], '0', '15', true)
-- main winbar color for non-active windows
hl('WinBarNC', colors['background'], colors['dark_gray'], '0', '15', true)
...
o.laststatus = 3 -- set global statusline spanning all windows
o.statusline = ''
